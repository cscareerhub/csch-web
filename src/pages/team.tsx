...
const Team = ({ teamMembers }): ReactElement => (
  <>
    ...
    <div className={styles.teamPageWrapper}>
      ...
      <p className={styles.teamDescription}>
        Contributors lend a helping hand wherever necessary and have made many of our events, development projects, and
        community intiatives possible!
      </p>
