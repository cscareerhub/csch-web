...
We will begin taking your questions the day before in #event-questions, where you can vote with a "thumbs up" on your favorite ones. Questions with the highest votes will make it into our rotation, so be sure to get yours in early!
...
For future event notifications, please go to [#get-roles]() and grab the [@Event Notifications]() role.
